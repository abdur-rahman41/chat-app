        ...
        return RefreshIndicator(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
             ...
             bool isEmoji = controller.isEmoji(flag);
              print("Whether it is emoji ${isEmoji}");
              if(isEmoji==false)
                {
                  flag= flag[0].toUpperCase().toString();
                }
              else
                {
                  flag=flag;
              ...
              final imageUrl =
                  info?.imageUrl ?? 'https://via.placeholder.com/150';
              ...
              return ListTile(
                ...
                title: Text(
                    room.roomType == 'Single' ? (info?.name ?? "") : roomName),
                subtitle: Text(
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            onTap: () async {
                              var result = await controller.createRoom(
                                  receiverID!, user.name!, user.imageUrl!);
